...
export const BookingDialog = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!res.ok) {
      ...
      toast({ title: "Σφάλμα κράτησης", description: err?.error || `HTTP ${res.status}`, variant: "destructive" });
      setStep("details");
      return;
    }
  ...
  const handleDownloadICS = () => {
    ...
    a.href = url; a.download = `${confirmationCode}.ics`;
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <Textarea id="reason" value={form.reason} onChange={(e) => setForm({ ...form, reason: e.target.value })} placeholder="Σύντομη περιγραφή των συμπτωμάτων" maxLength={500} rows={3} disabled={step === "submitting"} />
